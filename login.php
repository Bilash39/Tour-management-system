...
<?php }  ?>
	...
	<h1 class="text-center text-info">User Login form</h1>
	<form action="confirm_login.php" method="POST">
		...
		<a class="btn btn-success mt-3" href="logout.php">logout</a>
	</form>
	<br><br>
	<h4 class="">Did not sign up? Sign up now <button><a href="signup.php">Sign up</a></button></h4>
